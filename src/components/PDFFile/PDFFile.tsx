    ...
    <>
      <Document>
        <Page size="A4" orientation="portrait" style={styles.page}>
            ...
            <View style={styles.container}>
              ...
              <View style={styles.columnHeader}>
                <Text style={[styles.title, { alignSelf: "flex-end" }]}>
                  Invoice{" "}
                  <Text style={styles.data}>#{props.invoiceNumber}</Text>
                </Text>
                <Text style={[styles.line, { alignSelf: "flex-end" }]}>
                  Date: <Text style={styles.data}>{formattedDate}</Text>
                </Text>
                {props.invoiceDueDate ? (
                  <Text style={[styles.line, { alignSelf: "flex-end" }]}>
                    Due Date:{" "}
                    <Text style={styles.data}>
                      {props.invoiceDueDate.toLocaleDateString("en-US", {
                        day: "2-digit",
                        month: "short",
                        year: "numeric"
                      })}
          ...
          <View style={styles.block}>
            ...
            <View style={styles.tableRow}>
              <Text style={styles.tableCell}>
                <Text style={styles.data}>{props.senderName}</Text>
              </Text>
              <Text style={styles.tableCell}>
          ...
          <View style={styles.block}>
            <View style={styles.tableRow}>
              <Text style={{ ...styles.tableCellNameTitle, flex: 2 }}>
                Name
              </Text>
              ...
              <View style={styles.priceBlock}>
                <View style={styles.price}>
                  ...
                  {props.discount !== "0" && (
                    <>
                      ...
                      <Text style={styles.data}>
                        {props.discountType === "flat" && <>{props.currency}</>}
                        {props.discount}
                  ...
                  {props.tax !== "0" && (
                    <>
                      <Text style={styles.line}>Tax: </Text>
                      <Text style={styles.data}>{props.tax}%</Text>
                    </>
                  )}
                  {props.shipping !== "0" && (
                    <>
                  ...
                  <Text style={[styles.line, styles.lineTotal]}>Total: </Text>{" "}
                  <Text style={[styles.data, styles.lineTotalData]}>
                    {props.currency}
                ...
                <View style={styles.notes}>
                  <Text style={styles.line}>
                    Notes: <Text style={styles.data}>{props.invoiceNote}</Text>
                  </Text>
                </View>
              </View>
            </View>
